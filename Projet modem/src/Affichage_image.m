% Chargemement des matrices contenant des parties de l'image à reconstituer
% Demodulation des données contenues dans la matrice
...
% Reconstitution des images démodulées
